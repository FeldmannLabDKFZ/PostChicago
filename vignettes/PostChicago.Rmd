...
# for (id in ids){
#   print(id)
#   getBedGraphsNormGetbednorm(id,L,rmapgr,baited_genes=baited_genes,outputDir = paste0(outputDir,'/bedgraphs'))    
# }
```
...
##TO DO: finish this, oneGeneOnePeak funktioniert nicht!
